...
QVariant SegmentsTestModel::data(const QModelIndex &index, int role) const {
  ...
  if (role == Qt::DisplayRole) {
    ...
    else if(index.column() == 14) return QVariant(); 
    else if(index.column() == 15) return QVariant();
    else if(index.column() == 16) return QVariant(); 
    ...
    else if(index.column() == 14) return line.secondaryL;
    else if(index.column() == 15) return line.finalJ;
    else if(index.column() == 16) return line.delta;
...
bool SegmentsTestModel::setData(const QModelIndex &index, const QVariant &value, int role) {
  if (index.isValid() && role == Qt::EditRole ) {
    ...
    else if(index.column() == 14) tempData.secondaryL=value.toInt();
    else if(index.column() == 15) tempData.finalJ=value.toDouble();
    else if(index.column() == 16) tempData.delta=value.toDouble();
    else return false;
